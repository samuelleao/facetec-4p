export var Config = (function () {
  ...
  function retrieveConfigurationWizardCustomization(FaceTecSDK) {
    ...
    var outerBackgroundColor = "#0a0a0a";
    var frameColor = "#0a0a0a";
    var borderColor = "#0a0a0a";
    var ovalColor = "#d1df26";
    var dualSpinnerColor = "#d1df26";
    var textColor = "#ffffff";
    var buttonAndFeedbackBarColor = "#d1df26";
    var buttonAndFeedbackBarTextColor = "#0a0a0a";
    var buttonColorHighlight = "#ffffff";
    var buttonColorDisabled = "#262626";
    ...
    // console.log(defaultCustomization.overlayCustomization);
  ...
  function retrieveLowLightConfigurationWizardCustomization(FaceTecSDK) {
    ...
    // Set ID Scan Customization
    lowLightCustomization.idScanCustomization.selectionScreenForegroundColor =
      textColor;
